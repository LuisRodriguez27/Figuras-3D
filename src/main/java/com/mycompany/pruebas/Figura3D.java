...
//        Sphere sphere = new Sphere(32, 32, 1.5f);
...
//        Cylinder cylinder = new Cylinder(16, 32, 0.5f, 2f, true);
...
//        Torus torus = new Torus(32, 32, 0.4f, 1.5f);
...
//    }
//
//    private void agregarWireframe(AssetManager assetManager) {
...
public class Figura3D {
    ...
    public void quitarWireframe() {
        if (wireframe != null && figuraGroup.hasChild(wireframe)) {
            figuraGroup.detachChild(wireframe);
        }
    }
