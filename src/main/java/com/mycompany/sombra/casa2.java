...
public class casa2 extends SimpleApplication {
    ...
    public void simpleInitApp() {
        ...
        floor.setLocalTranslation(-1, 0, 1); // Posicionar en el suelo
        rootNode.attachChild(floor);

        // Cargar el modelo del edificio desde Blender
        building = assetManager.loadModel("Models/SINPISO.obj");
